...
(
  ...
  export LEXICON_STORAGE_BACKEND LEXICON_POSTGRES_URL LEXICON_POSTGRES_BOOTSTRAP_FROM_SQLITE
  cd services
...
(
  ...
  export OWNER_SERVICES_STORAGE_BACKEND OWNER_SERVICES_POSTGRES_URL OWNER_SERVICES_POSTGRES_BOOTSTRAP_FROM_SQLITE
  export ASSIGNMENTS_STORAGE_BACKEND ASSIGNMENTS_POSTGRES_URL ASSIGNMENTS_POSTGRES_BOOTSTRAP_FROM_SQLITE
  cd services
