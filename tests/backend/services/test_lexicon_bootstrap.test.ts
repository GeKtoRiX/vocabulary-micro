...
describe('lexicon bootstrap', () => {
  it('retries bootstrap after failure', async () => {
    ...
    vi.doMock('../../../backend/services/lexicon-service/src/repository.js', async () => {
      const actual = await vi.importActual<typeof import('../../../backend/services/lexicon-service/src/repository.js')>(
        '../../../backend/services/lexicon-service/src/repository.js',
      )
      return {
        ...actual,
