...
def audit_ui_imports(*, root_path: str | Path, ui_path: str = "frontend") -> dict[str, Any]:
    """Проверить файлы frontend/UI-слоя на запрещённые импорты из infrastructure.

    Args:
        root_path: Корень репозитория.
        ui_path: Относительный путь к frontend/UI-пакету.
